...
public interface ContratoRepository extends JpaRepository<Contrato, Long> {
	...
	Page<Contrato> findContratosByRange(@Param("latitude") final String latitude, @Param("longitude") final String longitude, @Param("range") final Double distance, Pageable pageable);
